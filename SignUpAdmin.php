...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(mysqli_num_rows($result) == 0){ // if there exists no users with the given TC no, email, username and phone number
        if($password == $password_confirm){
            createAdmin($tc_no, $email, $user_name, $phone, $dob, $password, $connection);
        }
        else{
...
<html lang="en">
  ...
  <head>
    ...
    <title>Betman - Sign Up Admin</title>
              ...
              <form id="contact" action="" method="post">
                <div class="row">
                  <div class="col-md-12 col-sm-12">
				  	<form action="SignUpAdmin.php" method="POST" name="SIGNUP" onsubmit="return valid()">
                    <fieldset>
